...
<div class="row">
    <div class="col-md-10">
        <h3>Lista Nota de Credito / Debito </h3>
    </div>
    <div class="col-md-2">
        <button class="btn btn-primary " onclick="mostrarAgregarNotaCreditoCompra(); return false;"><i class="fa fa-plus"></i> Agregar</button>
    </div>
    <div class="col-md-12">
        <hr> 
    </div>
